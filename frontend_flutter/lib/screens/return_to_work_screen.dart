...
class _ReturnToWorkScreenState extends ConsumerState<ReturnToWorkScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: AppColors.bgCard, title: Text('Return to Work', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w800, color: AppColors.textDark))),
      body: _loading
          ? const Center(child: CircularProgressIndicator())
          : ListView(padding: const EdgeInsets.all(16), children: [
              Text('What kind of work do you do?', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.textDark)),
              ...
              for (final j in _jobs)
                Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(j.$3, style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textDark)),
              ...
              if (_plan?['plan'] != null) ...[
                ...
                Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Your plan', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w800, color: AppColors.teal)),
                    const SizedBox(height: 6),
                    Text((_plan!['plan']['guidance'] as String?) ?? '', style: GoogleFonts.poppins(fontSize: 13, color: AppColors.textDark, height: 1.4)),
                    if ((_plan!['target_date']) != null) ...[
                      const SizedBox(height: 8),
                      Text('Target return date: ${_plan!['target_date']}', style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.textMedium)),
                    ],
                      ...
                      Padding(
                        ...
                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Container(
                            ...
                            child: Text('Wk ${m['week']}', style: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.w700, color: AppColors.tealDark)),
                          ),
                          const SizedBox(width: 10),
                          Expanded(child: Text(m['note'] as String? ?? '', style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textDark))),
                        ]),
                      ),
                  ]),
                ),
