...
class _OnboardingFlowState extends ConsumerState<OnboardingFlow> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                Text('${_index + 1}/$_totalPages', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.textMedium)),
              ]),
            ),
            Expanded(
              child: PageView(
  ...
  Widget _title(String t, String sub) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(t, style: GoogleFonts.poppins(fontSize: 23, fontWeight: FontWeight.w800, color: AppColors.textDark)),
        const SizedBox(height: 6),
        Text(sub, style: GoogleFonts.poppins(fontSize: 14.5, color: AppColors.textMedium, height: 1.4)),
  ...
  Widget _welcomePage() => Center(
        child: _scroll([
          ...
          Text("Welcome — I'm Mio 🤍", textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w800, color: AppColors.textDark)),
          ...
          Text(
            ...
            style: GoogleFonts.poppins(fontSize: 15, color: AppColors.textMedium, height: 1.55),
          ),
        ]),
      );
  ...
  Widget _medicalPage() => _scroll([
        ...
        Text('Surgery type', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.textDark)),
        const SizedBox(height: 8),
        ..._surgeryTypes.map((t) => _radioTile(t.$2, _surgeryType == t.$1, () => setState(() => _surgeryType = t.$1))),
        const SizedBox(height: 18),
        Text('Surgery date', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.textDark)),
        const SizedBox(height: 8),
        Row(children: [
          Expanded(
        ...
        const SizedBox(height: 18),
        Text('How does your heart limit you? (NYHA)', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.textDark)),
        const SizedBox(height: 8),
  ...
  Widget _gad7Page() => _scroll([
        ...
        ...List.generate(_gad7Questions.length, (q) => Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('${q + 1}. ${_gad7Questions[q]}', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textDark, height: 1.35)),
                ...
                Wrap(spacing: 8, runSpacing: 8, children: List.generate(4, (opt) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(_gad7Options[opt], style: GoogleFonts.poppins(fontSize: 12.5, fontWeight: FontWeight.w600, color: sel ? Colors.white : AppColors.textMedium)),
                    ),
                  );
                })),
              ]),
  ...
  Widget _finishPage() => Center(
        child: _scroll([
          ...
          Text("You're all set! 🎉", textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w800, color: AppColors.textDark)),
          const SizedBox(height: 12),
          Text(
  ...
  Widget _radioTile(String label, bool selected, VoidCallback onTap) => GestureDetector(
        ...
        child: Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: Text(label, style: GoogleFonts.poppins(fontSize: 14, fontWeight: selected ? FontWeight.w700 : FontWeight.w500, color: AppColors.textDark))),
          ]),
        ),
      );
...
class _HospitalStepState extends State<_HospitalStep> {
  ...
  Widget build(BuildContext context) {
    if (widget.status != 'none') {
      ...
      return SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          const SizedBox(height: 16),
          Text(approved ? 'Connected!' : 'Request sent', textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.textDark)),
          const SizedBox(height: 8),
          Text(
            approved
    ...
    return SingleChildScrollView(
      padding: const EdgeInsets.fromLTRB(24, 8, 24, 16),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('Connect with your hospital', style: GoogleFonts.poppins(fontSize: 23, fontWeight: FontWeight.w800, color: AppColors.textDark)),
        const SizedBox(height: 6),
        Text('So your care team can support your recovery (FR-014). You can also skip and do this later.', style: GoogleFonts.poppins(fontSize: 14.5, color: AppColors.textMedium, height: 1.4)),
        const SizedBox(height: 20),
        // toggle
        Row(children: [
          ...
          Column(children: _hospitals.map((h) => GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(child: Text(h.name, style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textDark))),
                    if (h.city != null) Text(h.city!, style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textLight)),
                  ]),
                ),
              )).toList()),
        const SizedBox(height: 16),
  ...
  Widget _toggle(String label, bool active, VoidCallback onTap) => Expanded(
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Text(label, textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 13.5, fontWeight: FontWeight.w700, color: active ? Colors.white : AppColors.textMedium)),
          ),
        ),
      );
}
