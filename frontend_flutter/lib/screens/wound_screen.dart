    ...
    showModalBottomSheet(
      ...
      builder: (_) => SafeArea(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ListTile(leading: const Icon(Icons.camera_alt_rounded, color: AppColors.teal), title: Text('Take a photo', style: GoogleFonts.inter(fontWeight: FontWeight.w600)), onTap: () { Navigator.pop(context); _add(ImageSource.camera); }),
          ListTile(leading: const Icon(Icons.photo_library_rounded, color: AppColors.teal), title: Text('Choose from gallery', style: GoogleFonts.inter(fontWeight: FontWeight.w600)), onTap: () { Navigator.pop(context); _add(ImageSource.gallery); }),
        ]),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Wound Log', style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.textDark)),
      ),
      body: _loading
          ...
          : ListView(padding: const EdgeInsets.all(20), children: [
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(_day != null ? 'Day $_day after surgery' : 'Wound care', style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w800, color: AppColors.textDark)),
                    const SizedBox(height: 4),
                    Text(_message, style: GoogleFonts.inter(fontSize: 12.5, color: AppColors.textMedium, height: 1.4)),
                  ])),
                ]),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(_uploading ? 'Uploading…' : 'Add wound photo', style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w700)),
              ...
              Text('Your photos', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.textDark)),
              const SizedBox(height: 10),
              if (_photos.isEmpty)
                Padding(padding: const EdgeInsets.symmetric(vertical: 20), child: Text('No photos yet. Add one above.', style: GoogleFonts.inter(fontSize: 13, color: AppColors.textLight)))
              else
                GridView.count(
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        Padding(
          ...
          child: Row(children: [
            Expanded(child: Text(day != null ? 'Day $day' : 'Logged', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.textDark))),
            ...
            Text(reviewed ? 'Reviewed' : 'Pending', style: GoogleFonts.inter(fontSize: 10, color: AppColors.textMedium)),
          ]),
        ),
      ]),
    );
